...
\section{Problématique - génération de variables aléatoires}
...
\section{Simulation de différentes lois}
...
Cette méthode est très utilisée pour simuler la loi normale. Pour ce faire, on reproduit la même méthode expliquée ci-dessus. La différence est qu'avec la loi normale, nous avons un support non compact, $  \mathbb{R} $.
