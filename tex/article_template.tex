...
telles que $x_1 = x_2$, la définition d'une fonction oblige que $f(x_1) = f(x_2)$. D'où vient la problématique : Comment générer des variables aléatoires alors que nous
